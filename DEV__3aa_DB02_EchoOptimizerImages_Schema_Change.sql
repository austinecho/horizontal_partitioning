...
CREATE CLUSTERED INDEX CIX_AuditRecords_CreatedDate ON dbo.AuditRecords ( CreatedDate ASC ) ON [PRIMARY];
...
CREATE CLUSTERED INDEX CIX_AuditRecordFields_CreatedDate ON dbo.AuditRecordFields ( CreatedDate ASC ) ON [PRIMARY];
...
ALTER TABLE dbo.AuditRecords
ADD CONSTRAINT PK_AuditRecords_Id_CreatedDate PRIMARY KEY NONCLUSTERED ( Id, CreatedDate ) ON [PRIMARY];
...
ALTER TABLE dbo.AuditRecordFields
ADD CONSTRAINT PK_AuditRecordFields_Id_CreatedDate PRIMARY KEY NONCLUSTERED ( Id, CreatedDate ) ON [PRIMARY];
